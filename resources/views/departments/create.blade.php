...
<div id="authentication-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[100%] max-h-full bg-black/50">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('departments.store') }}" method="POST">
                    @csrf
                    <div>
                        <label for="nama_department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            Department</label>
