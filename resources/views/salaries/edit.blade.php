<!-- Modal toggle -->
<button data-modal-target="edit-modal-{{ $salary->id }}" data-modal-toggle="edit-modal-{{ $salary->id }}"
...
<!-- Main modal -->
<div id="edit-modal-{{ $salary->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-modal-{{ $salary->id }}">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('salaries.update', $salary->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div>
                            <label for="tunjangan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tunjangan</label>
                            <input type="number" name="tunjangan" id="tunjangan" value={{ old('tunjangan', $salary->tunjangan) }} min="0"
                                step="1"
                        ...
                        <div>
                            ...
                            <input type="number" name="potongan" id="potongan" value={{ old('potongan', $salary->potongan) }} min="0"
                                step="1"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
                        </div>
                    <button type="submit"
